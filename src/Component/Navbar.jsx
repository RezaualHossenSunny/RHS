...
const Navbar = () => {
  ...
  <h1 className='font-loto text-2xl  font-black text-comon ml-1 '>RHS</h1>
      ...
      <p className='  text-center font-bold hover:text-slate-700 '>ABOUT</p>
      </Link>
            
          </li>
          <li>
          <Link smooth spy to="whatido">
         <p className='pl-4  text-center font-bold hover:text-slate-700  '>WHAT I Do?</p>
         </Link>
          </li>
          <li>
          <Link smooth spy to="skill">
         <p className='pl-4 text-center font-bold hover:text-slate-700  '>SKILL</p>

         </Link>
          </li>
          <li>
          <Link smooth spy to="portfolio">
          <p className='pl-4  text-center font-bold hover:text-slate-700  '>PORTFOLIO</p>
          </Link>
          </li>
          <li>
          <Link smooth spy to="coontacet">
          <p className='pl-4 text-center font-bold hover:text-slate-700 '>CONTACT</p>
          </Link>
          </li>
        </ul>
