    ...
    <div id="portfolio">
      <div className="max-w-container mx-auto py-32">
        <div className=" flex justify-center">
          <h1 className="text-center font-inter text-4xl font-bold leading-9 ">
            PORTFOLIO
          </h1>
          ...
          <div className=" w-full md:w-[200px] lg:w-3/12 mt-4 md:mt-o">
            <div className="border-2 border-gray-400 rounded-xl pb-3">
              ...
              <p className="font-inter text-center mt-4 md:text-lg font-normal ot-italic leading-6 text-[#717171]">
                Technology :JavaScript, css, figma,html.css
              </p>

              <div className="flex justify-center mt-4 md:mt-8">
                <a
                  href="https://github.com/RezaualHossenSunny"
                  className="p-2 md:p-4 bg-comon rounded-xl text-white font-inter font-bold w-[200px] text-center"
                >
                  Vew More
                </a>
        ...
        <div className="flex justify-center mt-4 md:mt-10">
          <a
            href="https://github.com/RezaualHossenSunny"
            className="p-4 bg-gray-500 rounded-xl text-white font-inter font-bold w-[200px] text-center hover:bg-comon"
          >
            Vew More
          </a>
        </div>
